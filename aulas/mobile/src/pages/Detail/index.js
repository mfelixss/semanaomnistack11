...
export default function Detail(){
    ...
    const message = `Ola ${incidents.name}, estou entrando em contato pois gostaria de ajudar no caso ${incidents.title}, com o valor de ${Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(incidents.value)}`;
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.incidents}>
                        ...
                        <Text style={styles.incidentsValue}>{Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(incidents.value)}</Text>   
            </View>     
